...
# The pip is broken, thus copied code from https://github.com/Conway/perspectives
...
def main():
    parser = argparse.ArgumentParser(description='Testing of perspective API',
                                     prog='perspective.py',formatter_class=argparse.ArgumentDefaultsHelpFormatter)

    parser.add_argument("-a", "--api", dest='api',
                        type=str, help='API file', default="api")
    ...
    tests = ["This is so cool. It's like, 'would you want your mother to read this??' Really great idea, well done!",
    ...
    for i, text in enumerate(tests):
        ...
        toxicity = client.score(text, tests=["TOXICITY"])
        print("TOXICITY SCORE for "+ text + ":" + str(toxicity["TOXICITY"].score))
